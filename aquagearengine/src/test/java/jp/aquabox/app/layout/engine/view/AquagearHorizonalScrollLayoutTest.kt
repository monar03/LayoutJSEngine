...
class AquagearHorizonalScrollLayoutTest {
    @Test
    fun `タップできない`() {
        val v = aquagearHorizonalScrollLayout(mock {}, mapOf(), mapOf())
    ...
    fun `タップできる`() {
        ...
        val v = aquagearHorizonalScrollLayout(
            module,
    ...
    private fun aquagearHorizonalScrollLayout(
        module: LayoutModule,
        params: Map<String, StringVariable.Parameter>,
        styles: Map<String, String>
    ): AquagearHorizonalScrollLayout {
        return AquagearHorizonalScrollLayout(RuntimeEnvironment.application).apply {
            set(
                module,
                params,
                styles,
