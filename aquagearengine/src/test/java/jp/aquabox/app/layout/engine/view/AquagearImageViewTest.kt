...
class AquagearImageViewTest {
    @Test
    fun `タップできない`() {
        val v = aquagearImageView(mock {}, mapOf(), mapOf())
    ...
    private fun aquagearImageView(
        module: LayoutModule,
        params: Map<String, StringVariable.Parameter>,
        styles: Map<String, String>
    ): AquagearImageView {
        return AquagearImageView(RuntimeEnvironment.application).apply {
            set(
                module,
                params,
                styles,
