...
class AquagearScrollLayoutTest {
    @Test
    fun `タップできない`() {
        val v = aquagearScrollLayout(mock {}, mapOf(), mapOf())
    ...
    private fun aquagearScrollLayout(
        module: LayoutModule,
        params: Map<String, StringVariable.Parameter>,
        styles: Map<String, String>
    ): AquagearScrollLayout {
        return AquagearScrollLayout(RuntimeEnvironment.application).apply {
            set(
                module,
                params,
                styles,
